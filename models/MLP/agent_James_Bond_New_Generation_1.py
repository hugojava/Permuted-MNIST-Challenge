"""
name_file = agent_James_Bond_New_Generation_1.py
Permuted MNIST — MLP Submission (fast, 1-layer)
Config (~40 s/task locally):
hidden=(1024,), dropout=0.10, batch_size=256,
...
def build_mlp(input_dim=784, hidden=(1024,), dropout=0.10, num_classes=10):
    layers = []
    d = input_dim
    for h in hidden:
